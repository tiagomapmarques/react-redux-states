...
var strip = function (str, config) {
    var prefix = config.ACTIONS_PREFIX || config_1.getConfig().ACTIONS_PREFIX;
    var suffix = config.ACTIONS_SUFFIX || config_1.getConfig().ACTIONS_SUFFIX;
    var result = str;
...
exports.actionsSelector = function (actions, config) { return function () {
    ...
    return function (dispatch) {
        ...
        var init = config.INIT_FUNCTION || config_1.getConfig().INIT_FUNCTION;
